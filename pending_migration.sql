...
-- CreateTable
CREATE TABLE "myneta_serious_crimes" (
    "id" SERIAL NOT NULL,
    "candidate_name" TEXT NOT NULL,
    "candidate_profile_url" TEXT NOT NULL,
    "constituency" TEXT NOT NULL,
    "party" TEXT NOT NULL,
    "criminal_cases_count" INTEGER NOT NULL,
    "education" TEXT NOT NULL,
    "total_assets_raw" TEXT NOT NULL,
    "liabilities_raw" TEXT NOT NULL,
    "election_year" INTEGER NOT NULL,
    "state" TEXT NOT NULL,
    "source_url" TEXT NOT NULL,
    "scraped_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "myneta_serious_crimes_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "politician_relationships_politician_id_related_politician_i_key" ON "politician_relationships"("politician_id", "related_politician_id", "relationship_type");
